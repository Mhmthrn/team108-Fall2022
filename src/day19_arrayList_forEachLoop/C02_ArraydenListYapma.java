...
public class C02_ArraydenListYapma {
    public static void main(String[] args) {
        ...
        System.out.println("aslist ile tasinan list2 : "+ list2);

       // list2.add(6);

        arr[0]=10;
        System.out.println(Arrays.toString(arr));// [10, 3, 4, 5, 6, 9, 8, 7, 4]
        System.out.println(list2);// [10, 3, 4, 5, 6, 9, 8, 7, 4]
